export function crystalsToTime(x) {
  return Math.floor(
    x > 86400 && x <= 1209600
...
export function crystalsToCredits(x) {
  return Math.floor(
...
export function crystalsToHydrogen(x) {
  return Math.floor(
    x > 100000 && x <= 1000000
...
export function timeToCrystals(x) {
  return Math.ceil(
    x > 300 && x <= 3000
...
export function creditsToCrystals(x) {
  return Math.ceil(
    x > 12000
      ? 9999999
      : x > 4000 && x <= 12000
...
export function hydrogenToCrystals(x) {
  return Math.floor(
    x > 10000
      ? 999999
      : x > 2000 && x <= 10000
